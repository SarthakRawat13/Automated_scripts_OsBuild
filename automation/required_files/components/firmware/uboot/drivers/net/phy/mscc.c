...
#define PHY_ID_VSC8501			0x00070531
...
static int vsc8501_config(struct phy_device *phydev)
{
...
static struct phy_driver VSC8501_driver = {
	.name = "Microsemi VSC8501",
	.uid = PHY_ID_VSC8501,
	.mask = 0x000ffff0,
	.features = PHY_GBIT_FEATURES,
	.config = &vsc8501_config,
	.startup = &mscc_startup,
	.shutdown = &genphy_shutdown,
};
